...
本文直接给出 AUBB V1 的子系统划分、模块职责、核心流程、数据关系、界面入口、异常处理和测试计划摘要。其他材料可用于交叉校验，但不是理解本文的前置条件。
...
| 教师 | `/teacher/courses` | 教师课程列表 | 开课、班级、成员、公告、资源、讨论 |
| 教师 | `/teacher/courses/[offeringId]` | 教师课程工作区 | 课程总览、教学班、成员、公告、资源、讨论、作业、提交、实验、成绩、题库、判题环境 |
...
| 教师 | `/teacher/submissions/[submissionId]` | 教师提交详情 | 学员答案、附件、评测报告、重评、人工评分 |
| 教师 | `/teacher/grading/gradebook` | 成绩册 | 人工评分、导入导出、发布 |
| 教师 | `/teacher/labs` | 实验管理 | 实验、报告、评阅 |
| 学员 | `/student` | 学员首页 | 学习入口 |
| 学员 | `/student/courses` | 学员课程列表 | 课程公告、资源、讨论 |
| 学员 | `/student/courses/[offeringId]` | 学员课程工作区 | 公告、资源、讨论、作业、实验、成绩等课程上下文入口 |
| 学员 | `/student/assignments` | 学员作业列表 | 全部作业、课程作业、详情入口 |
| 学员 | `/student/assignments/[assignmentId]` | 学员作业详情 | 题目、附件、在线工作区入口、整份作业提交 |
| 学员 | `/student/assignments/[assignmentId]/workspace/[questionId]` | 在线工作区 | 文件树、编辑、保存、样例运行、保存并返回 |
| 学员 | `/student/submissions/[submissionId]` | 学员提交详情 | 分题答案、附件、评测结果、报告下载 |
| 学员 | `/student/grades` | 学员成绩 | 成绩册、导出 |
| 学员 | `/student/labs` | 学员实验 | 报告实验、终端实验、教学班筛选、附件和评阅反馈 |
...
| 页面 | 核心区域 | 交互 |
| --- | --- | --- |
| 教师课程 | 开课卡片/表格、课程工作区、班级、成员入口 | 教师可管理开课，助教按授权范围查看 |
...
| 页面 | 核心区域 | 交互 |
| --- | --- | --- |
| 学员课程 | 当前课程、公告、资源、讨论、课程作业、课程实验、课程成绩入口 | 只显示有成员关系的课程，并支持课程上下文导航 |
| 学员作业 | 作业状态、截止时间、作业详情、在线工作区入口、整份提交入口 | 关闭或无权限时禁止提交 |
| 在线工作区 | 文件树、编辑器、运行输入、运行结果、保存并返回按钮 | 自动保存、手动保存、文件操作、修订恢复、模板重置；整份作业提交在作业详情页完成 |
| 提交详情 | 分题答案、附件、评测结果、报告下载 | 评测中/成功/失败状态明确 |
| 我的成绩 | 已发布成绩、导出入口、反馈 | 未发布成绩不展示 |
| 学员实验 | 实验说明、教学班筛选、报告草稿、附件、Web 终端会话、评阅结果 | 报告实验区分草稿、提交、已评阅；终端实验支持启动、停止、重置和连接 token |
...
| 缓存 | Redis 可选增强 | 会话、评测报告、未读数、个人课程列表、题库字典、组织作用域设置短 TTL |
...
| 14 | 压力与容量测试 | 全平台容量边界 | 读请求阶梯、写提交、评测轮询、真实 go-judge、重评、文件上传下载、通知/SSE、实验运行时、Kubernetes Web 终端、soak 稳定性 | 上线前或容量变更前 |
