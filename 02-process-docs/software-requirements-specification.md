...
| IN-04 | 学员被教师或管理员加入课程后，查看任务、使用在线 IDE 编辑 / 运行并保存编程题答案，或进行文件提交 |
...
- BR-NTF-01：通知触发事件至少包括任务发布、提交受理、评测完成、成绩发布、成绩重新发布和系统公告。
...
| Task | 所属课程、任务类型、Markdown 说明、规则、评分方式、状态、版本 | 支持任务版本留痕和状态管理 |
| Lab | 所属开课或教学班、实验类型、Markdown 实验内容、环境说明、状态 | 支持报告型实验，并为后续虚拟机实验预留环境与会话信息 |
...
| 任务与规则 | FR-TSK-01 ~ FR-TSK-07 | UC-03 | Task, Lab | D/T/I |
