...
| 组织与用户 | 维护组织结构、导入用户、管理学校 / 学院 / 课程分层管理员和账号状态 | FR-CFG-03 ~ FR-CFG-05 |
...
| 成员管理 | 由教师、整课助教或管理员维护课程成员，不提供学员自助邀请码加入 | FR-CRS-03, FR-CRS-04 |
| 课程资源 | 上传、分类和组织课程资源 | FR-CRS-05 |
| 任务管理 | 创建任务、维护支持 Markdown 的任务说明、配置规则和评分方式、发布和关闭任务 | FR-TSK-01 ~ FR-TSK-05 |

### 3.3 学员提交与结果处理

| 模块 | 需求内容 | 对应 SRS |
| --- | --- | --- |
| 在线 IDE 与提交 | 支持在线 IDE 编辑 / 运行、保存编程题、文件上传、展示提交要求；整份作业提交在作业详情页完成 | FR-SUB-01 ~ FR-SUB-09 |
...
| 成绩处理 | 生成最终成绩，控制首次发布与重新发布 | FR-REV-03, FR-REV-04 |
...
2. 教师可创建课程、发布任务并查看提交。
3. 学员可查看已加入课程、在在线 IDE 中运行并保存编程题，再从作业详情页提交整份作业并查看结果。
