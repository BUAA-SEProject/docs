...
| 提交与在线作业 | 学员、教师、助教 | 作业提交、提交历史、提交校验、IDE 编程题保存和草稿管理 | 任务规则、课程成员关系 | 自动评测和人工批改输入 |
| 自动评测与隔离执行 | 系统、教师、学员 | 自动评测调度、状态流转、结果输出和重评 | 提交记录、评测环境 | 结构化评测结果 |
| 环境型实验 | 教师、学员 | Web 终端实验创建、环境启动、终端连接和会话状态查看 | 课程成员关系、实验定义、环境模板 | 学生专属实验环境与会话状态 |
| 人工批改与成绩 | 教师、助教、学员 | 批改、成绩生成、发布、重新发布 | 提交和评测结果 | 学员反馈与教学统计 |
...
| 任务与评分规则 | Task, Lab |
| 提交与在线作业 | Submission, IDEWorkspace |
| 自动评测与隔离执行 | Submission, EvaluationResult |
| 环境型实验 | Lab, LabEnvironmentProfile, LabSession, LabConnectionToken |
