...
本系统是面向高校、职业培训机构和企业培训部门的一体化在线教学与实训平台。平台以 Web 端为主要入口，统一承载课程组织、任务发布、在线提交、自动评测、人工批改、成绩发布和平台治理能力。
...
| IN-04 | 在线提交 | 在线编辑、文件上传、提交受理、提交历史查询 |
...
| 学员 | 完成学习任务并获取结果 | 加课、看任务、提交、看结果、看成绩 |
