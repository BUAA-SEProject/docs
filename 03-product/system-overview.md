...
2. 教师创建课程、组织资源并发布任务。
3. 学员被教师或管理员加入课程后查看任务，并在在线 IDE 中编辑、运行、保存编程题答案，再回到作业界面完成整份作业提交。
4. 系统受理提交并在需要时自动评测。
...
| IN-06 | 人工批改与成绩 | 人工评分、成绩生成、发布、重新发布和导出 |
...
| 整课助教 | 在开课范围内协助教师完成教学运行 | 成员管理、题库、作业、提交、判题、成绩、实验 |
| 班级助教 | 在授权教学班内协助批改与反馈 | 本班提交、批改、本班成绩册 |
| 学员 | 完成学习任务并获取结果 | 看课程、看任务、在线 IDE 编辑 / 运行、保存编程题、提交整份作业、看结果、看成绩 |
