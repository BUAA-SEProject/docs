...
| 角色 | 一级导航 | 核心页面 |
| --- | --- | --- |
| 学员 | 我的课程、通知、个人中心 | 课程详情、任务详情、在线提交、成绩详情 |
| 教师 | 课程管理、任务管理、批改中心、统计分析 | 课程编辑、任务发布、提交详情、成绩总表 |
...
| `taskStore` | 当前任务、提交规则、测试用例、Rubric |
...
- 中部：Markdown 任务说明、附件下载、样例输入输出。
- 底部：在线编辑器 / 上传区、历史提交列表、当前评测结果。
