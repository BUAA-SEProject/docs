...
| BUG-20260605-006 | P2 | /teacher/courses/1/question-bank | 编辑题目按钮点击无反应（无对话框弹出） | 已记录 |
| BUG-20260605-007 | P1 | /student/labs | 学生实验报告保存草稿失败（API /api/v1/me/labs/18/report 返回 404/400） | 已记录 |
