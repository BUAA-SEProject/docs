...
| TEACHER-009-EDIT-ARCHIVE | 已补证 | 以开课 `32` 的授课教师账号打开 `/teacher/courses/32/question-bank?offeringId=32`，创建题目 `75` `MCP-R2-06102249 题库编辑归档补证`，编辑为 `MCP-R2-06102249 题库编辑归档补证-EDIT`，随后确认归档；默认列表变为空，勾选“包含归档”后可回看该题。 | `182-r2-teacher-question-bank-edited-archived.png`；`product-full-verification-round2-evidence/runtime/teacher-question-bank-edit-archive-network.txt`；`product-full-verification-round2-evidence/runtime/teacher-question-bank-edit-archive-console.txt` |
...
| TEACHER-010-EDIT-ARCHIVE | 已补证 | 以开课 `32` 的授课教师账号打开 `/teacher/courses/32/judge-environments?offeringId=32`，创建判题环境配置 `40`，编辑为 `MCP-R2-06102255 Python 判题环境补证-EDIT`，随后确认归档；默认列表变为空，勾选“包含归档”后显示“已归档”。 | `183-r2-teacher-judge-environment-edited-archived.png`；`product-full-verification-round2-evidence/runtime/teacher-judge-environment-edit-archive-network.txt`；`product-full-verification-round2-evidence/runtime/teacher-judge-environment-edit-archive-console.txt` |
...
| TEACHER-018-EDIT-CLOSE | 已补证 | 以开课 `32` / 教学班 `234` 的授课教师账号打开 `/teacher/labs?offeringId=32&teachingClassId=234`，创建报告实验 `53`，编辑为 `MCP-R2-06102302 实验编辑关闭补证-EDIT`，随后发布并关闭；最终列表显示“已关闭”，发布和关闭按钮均禁用。 | `184-r2-teacher-lab-edited-closed.png`；`product-full-verification-round2-evidence/runtime/teacher-lab-edit-close-network.txt`；`product-full-verification-round2-evidence/runtime/teacher-lab-edit-close-console.txt` |
