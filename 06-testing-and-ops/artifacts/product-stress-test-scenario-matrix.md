...
| --- | --- | --- | --- | --- | --- | --- |
| 7.1 | 公共入口、认证与基础读请求 | 读请求 P95 < 500ms、P99 < 1500ms、错误率 < 1%、5xx=0；登录风暴单独统计 | 读请求 50/200/500 并发 2/3/3 分钟 | 50 并发通过；200 并发 P95 2358.92ms、错误率 2.07%、5xx 478；500 并发错误率 29.03%、5xx 9514。登录风暴未单独完成。 | 失败 | `product-stress-test-evidence/raw/STRESS-0611132804/contract-run/perf_results_contract.json`；`server-log-stress-errors-excerpt.log` |
