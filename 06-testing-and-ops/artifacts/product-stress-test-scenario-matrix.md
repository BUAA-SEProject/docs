...
| --- | --- | --- | --- | --- | --- | --- |
| 7.1 | 公共入口、认证与基础读请求 | 读请求 P95 < 500ms、P99 < 1500ms、错误率 < 1%、5xx=0；登录风暴单独统计 | 第九批短诊断跑读请求 50/200 并发 2/3 分钟 | 50 并发 65192 请求全 200、P95 31.21ms、P99 48.70ms；200 并发 133697 请求全 200、P95 439.77ms、P99 2418.45ms、5xx=0。500/1000 与登录风暴未重测；P99 仍高于 1500ms 的完整阈值。 | 失败 | `product-stress-test-evidence/raw/STRESS-06120105-read-after-hikaritimeout/read_after_hikaritimeout_results.json`；`product-stress-test-evidence/raw/STRESS-06120105-read-after-hikaritimeout/server.log` |
