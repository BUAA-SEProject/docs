...
| 7.15 | 全平台 Soak、混合流量与容量边界 | 读 100 并发 30 分钟，写 10 并发 10 分钟，go-judge/SSE/Web 终端/下载混合 | 第十一批复测 100 并发 10 分钟 smoke soak | 384751 请求，RPS 640.96，P95 20.36ms，P99 54.17ms，错误率 0，5xx=0，状态码 200=377055、201=7696。完整 30 分钟和 Kubernetes/WebSocket 混合未完成。 | 阻塞 | `raw/STRESS-0612022949/cache-fix-soak/perf_results_cache_fix_soak.json`；`commands/STRESS-0612022949/16-healthcheck-after-soak.log` |
